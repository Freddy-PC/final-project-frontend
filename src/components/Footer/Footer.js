  ...
  return (
    <footer className="footer app__section">
      ...
      <div className="footer__images">
        <a
          href="https://www.linkedin.com/in/freddy-perez-camacho/"
          target="_blank"
          rel="noopener noreferrer"
        >
          <svg
            className="image footer__image-linkedIn"
